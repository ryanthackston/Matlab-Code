...
definput = cell(11,1);
definput(:) = [{'1'};{'13'};{'8.5'};{'12'};{'0.5'};{'3'};{'0.5'};{'0'};{'2'};{'50'};{'2'}];
...
[RestOnset, MoveOnset, labels] = meg_offsetdata_calib_aug2021(blocks, labels);
...
[C, err, P, logp, coeff] = meg_PLVclassify2(Class_Vec, PLV_features)
